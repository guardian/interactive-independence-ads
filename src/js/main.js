...
function removeHeaderContent() {
    // Remove header content added by Labour and Liverpool template
    var labourLiverpoolHeader = document.querySelectorAll('.content--labour-liverpool-article');
    var labourLiverpoolStandfirst = document.querySelectorAll('.immersive-header-container--labour-liverpool .content__wrapper--standfirst');
    var labourLiverpoolStyles = document.querySelectorAll('.immersive-header-container--labour-liverpool style');
    var headerElements = [labourLiverpoolHeader, labourLiverpoolStandfirst, labourLiverpoolStyles];
    var headerElement;

    for (var i = 0; i < headerElements.length; i += 1) {
        headerElement = headerElements[i];
        if (headerElement.length) {
            headerElement[0].remove();
        }
    }
}
